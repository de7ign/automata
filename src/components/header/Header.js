      ...
      <AppBar position="static" style={{background: '#42a5f5'}}>
        <Toolbar>
          ...
          <Tooltip title="Video Tutorial">
            <IconButton color="inherit" aria-label="Tutorial" style={{position: "absolute", right: 80}}>
              <OndemandVideo />
            </IconButton>
          </Tooltip>
          <Tooltip title="Github">
            <IconButton color="inherit" aria-label="Github" style={{position: "absolute", right: 20}}>
              <SvgIcon>
